...
ACTION_SHORT_HELP: dict[str, str] = {
    ...
    "tags_set": "Batch add/remove tags on target",
    "reconcile_selection_cache": "Refresh cache entries for target",
    "suffix_set": "Set suffix category on target",
    "archive": "Move target projects to archive",
    ...
    "toggle_pack": "Toggle pack/unpack on archive target",
    "delete": "Delete target entries permanently",
    "set_desc": "Set description on target entries",
    "rename_item": "Rename target project folder(s)",
