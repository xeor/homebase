...
KNOWN_LAYERING_EXCEPTIONS = {
    ...
    "src/homebase/config/prefs.py:33 imports homebase.filter",
    "src/homebase/metadata/api.py:30 imports homebase.filter",
    "src/homebase/metadata/api.py:31 imports homebase.workspace",
    "src/homebase/metadata/api.py:8 imports homebase.archive",
    "src/homebase/tmux/flow.py:8 imports homebase.commands",
    "src/homebase/ui/__init__.py:3 imports homebase.context",
    "src/homebase/ui/__init__.py:4 imports homebase.runtime",
    "src/homebase/workspace/benchmark.py:23 imports homebase.commands.archive",
    "src/homebase/workspace/projects.py:150 imports homebase.tmux.flow",
    "src/homebase/workspace/projects.py:151 imports homebase.ui",
