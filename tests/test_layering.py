...
KNOWN_LAYERING_EXCEPTIONS = {
    ...
    "src/homebase/metadata/api.py:26 imports homebase.filter",
    "src/homebase/metadata/api.py:27 imports homebase.workspace",
    ...
    "src/homebase/workspace/projects.py:149 imports homebase.tmux.flow",
    "src/homebase/workspace/projects.py:150 imports homebase.ui",
